        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="header-elements">
              <div class="site-logo">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( $asset_uri ); ?>/img/logo/logo1.png" alt=""></a>
              </div>
              <div class="main-menu">
                <ul>
...
<div class="mobile-sidebar mobile-sidebar1">
  <div class="logosicon-area">
    <div class="logos">
      <img src="<?php echo esc_url( $asset_uri ); ?>/img/logo/logo1.png" alt="">
    </div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="header-main-content heading1">
          <h5><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/logo-icons.svg" alt="">Top #1 SEO & Marketing Agency</h5>
      ...
      <div class="col-lg-6">
        <div class="header-images-area">
          <div class="main-images-area">
            <div class="img1">
              <img src="<?php echo esc_url( $asset_uri ); ?>/img/all-images/header-img1.png" alt="" data-aos="zoom-in" data-aos-duration="1000">
            </div>
            <div class="img2">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-10">
        <div class="slider-images-area owl-carousel">
          <div class="img1">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/elements/brand-img1.png" alt="">
          </div>
          <div class="img1">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/elements/brand-img2.png" alt="">
          </div>
          <div class="img1">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/elements/brand-img3.png" alt="">
          </div>
          <div class="img1">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/elements/brand-img4.png" alt="">
          </div>
          <div class="img1">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/elements/brand-img5.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-4">
        <div class="about-images">
         <figure class="image-anime reveal">
          <img src="<?php echo esc_url( $asset_uri ); ?>/img/all-images/about-img1.png" alt="">
         </figure>
      ...
      <div class="col-lg-3">
        <div class="about-auhtor-images">
          ...
          <figure class="image-anime reveal">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/all-images/about-img2.png" alt="">
           </figure>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-7">
        <div class="images-content-area" data-aos="zoom-in" data-aos-duration="1000">
          <div class="img1">
            <img src="<?php echo esc_url( $asset_uri ); ?>/img/all-images/service-img1.png" alt="">
          </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <div class="footer-logo-area">
          ...
          <ul>
            <li><a href="#"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/facebook.svg" alt=""></a></li>
            <li><a href="#"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/instagram.svg" alt=""></a></li>
            <li><a href="#"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/linkedin.svg" alt=""></a></li>
            <li><a href="#"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/youtube.svg" alt=""></a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="footer-logo-area2">
          <h3>Get in touch</h3>
          <ul>
            <li><a href="mailto"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/email.svg" alt=""><span>Infoseoc@gmail.com</span></a></li>
            <li><a href="#"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/location.svg" alt=""><span>8708 Technology Forest <br class="d-lg-block d-none"> Pl Suite 125 -G, The <br class="d-lg-block d-none"> Woodlands, TX 773</span></a></li>
            <li><a href="tel:123-456-7890"><img src="<?php echo esc_url( $asset_uri ); ?>/img/icons/phone.svg" alt=""><span>123-456-7890</span></a></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4 col-md-6">
